...
# A hello-world ACAP application

This README file explains how to build a simple Hello World ACAP application. It is achieved by using the containerized API and toolchain images.
