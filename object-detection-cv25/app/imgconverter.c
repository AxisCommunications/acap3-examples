...
static void ARGBtoRAWPlanar(const uint8_t* srcARGB, uint8_t* dstRGB, unsigned int w,
                      int unsigned h);
static void ARGBtoRAWInterleaved(const uint8_t* srcARGB, uint8_t* dstRGB, unsigned int w,
                      int unsigned h);
...
void ARGBtoRAWInterleaved(const uint8_t* srcARGB, uint8_t* dstRGB, unsigned int w,
               unsigned int h) {
...
void ARGBtoRAWPlanar(const uint8_t* srcARGB, uint8_t* dstRGB, unsigned int w,
               unsigned int h) {
...
bool convertCropScaleU8yuvToRGB(const uint8_t* nv12Data, unsigned int srcWidth,
    ...
    if (!strcmp(outputFormat, "RGB-planar")){
        ARGBtoRAWPlanar(tempARGBsmall, rgbData, dstWidth, dstHeight);
    } else if(!strcmp(outputFormat, "RGB-interleaved")){
        ARGBtoRAWInterleaved(tempARGBsmall, rgbData, dstWidth, dstHeight);
    } else {
...
void padImageWidth(uint8_t* srcimage, uint8_t* dstimage, unsigned int width, unsigned int height, unsigned int padding){
