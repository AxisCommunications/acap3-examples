/**
 * Copyright (C) 2018-2022, Axis Communications AB, Lund, Sweden
 *
...
const struct argp argp = {
    ...
    "/usr/local/packages/tensorflow_to_larod/model/car_human_model_cavalry.bin 256 "
    "256 4 -c 6 \nwhere 6 here refers to the CV25 DLPU backend. The numbers for "
